...
heroText: Corona's blog
tagline: 热爱学习，热爱生活，热爱动漫，热爱这世间一切美好
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 后端
    details: Java、Go、Spring等后端技术
    link: /server/ # 可选
    imgUrl: /img/java.jpg # 可选
  - title: 前端
    details: HTML、CSS、JS、Vue等相关技术
    link: /web/
    imgUrl: /img/vue.jpg
  - title: 动漫
    details: 动漫推荐
...
<!-- bilibili -->
<img src="/img/bilibili.gif" class="panda no-zoom" style="width: 130px;height: 115px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;">
